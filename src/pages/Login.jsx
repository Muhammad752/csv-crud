...
export default function Login({ user }) {
  ...
  //   let res = axios.put(
  //     "http://192.168.15.55:9092/loans/pinfl/40801692730019/branchInfo/165.0/",
  //     {
  //       id: 131,
  //       invoice: "string",
  //       orgName: "string",
  ...
  //     },
  //     {
  //       headers: { "X-Client-IP": "192.168.239.41" },
  //     }
  //   );
  //   console.log(res);
  // }
                  ...
                  try {
                    ...
                    if (!e.response) {
                      setAlert({
                        type: "error",
                        value:
                          " Service is not accessible, check network connections",
                      });
                      console.log(
                        " Service is not accessible, check network connections"
                      );
